...
public class LoginControllerTest {
    ...
    @Test
    public void postLogin_withoutUsersCredentials_receiveUnauthorized() {
    ...
    @Test
    public void postLogin_withoutUsersCredentials_receiveApiError() {
        ResponseEntity<ApiError> response = login(ApiError.class);
        assertThat(response.getBody().getUrl()).isEqualTo(API_1_0_LOGIN);
    }

    @Test
    public void postLogin_withoutUsersCredentials_receiveApiErrorWithoutValidationErrors() {
    ...
    private void authenticate() {
        testRestTemplate.getRestTemplate().getInterceptors().add(new BasicAuthenticationInterceptor("test-username", "P4ssword"));
    }
